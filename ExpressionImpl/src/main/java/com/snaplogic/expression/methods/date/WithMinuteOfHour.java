 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#withMinuteOfHour
 * (int)}
 *
 * @author tstack
 */
public enum WithMinuteOfHour implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        try {
            return dateTime.withMinuteOfHour(MethodUtils.getArgAsNumber(args, 0).intValue());
