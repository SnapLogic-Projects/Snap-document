 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusYears(int)}
 *
 * @author tstack
 */
public enum PlusYears implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusYears(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
