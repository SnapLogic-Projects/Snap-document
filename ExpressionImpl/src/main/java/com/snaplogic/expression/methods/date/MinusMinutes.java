 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusMinutes(int)}
 *
 * @author tstack
 */
public enum MinusMinutes implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusMinutes(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
