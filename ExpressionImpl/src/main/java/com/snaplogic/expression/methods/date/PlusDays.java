 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusDays(int)}
 *
 * @author tstack
 */
public enum PlusDays implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusDays(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
