...
/**
 * Implementation of javascript string trimLeft method:
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/TrimLeft
 * ?redirectlocale=en-US&redirectslug=JavaScript%2FReference%2FGlobal_Objects%2FString%2FTrimLeft
 *
 * @author jinloes
 */
public enum TrimLeft implements Method {
    INSTANCE;
