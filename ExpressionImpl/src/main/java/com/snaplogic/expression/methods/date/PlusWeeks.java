 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusWeeks(int)}
 *
 * @author tstack
 */
public enum PlusWeeks implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusWeeks(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
