 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#withDayOfMonth(int)}
 *
 * @author tstack
 */
public enum WithDayOfMonth implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        try {
            return dateTime.withDayOfMonth(MethodUtils.getArgAsNumber(args, 0).intValue());
