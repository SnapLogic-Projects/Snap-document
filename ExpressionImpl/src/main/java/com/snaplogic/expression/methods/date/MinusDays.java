 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusDays(int)}
 *
 * @author tstack
 */
public enum MinusDays implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusDays(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
