 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#withYear(int)}
 *
 * @author tstack
 */
public enum WithYear implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.withYear(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
