 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusMinutes(int)}
 *
 * @author tstack
 */
public enum PlusMinutes implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusMinutes(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
