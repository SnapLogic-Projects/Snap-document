 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusSeconds(int)}
 *
 * @author tstack
 */
public enum MinusSeconds implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusSeconds(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
