 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusWeeks(int)}
 *
 * @author tstack
 */
public enum MinusWeeks implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusWeeks(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
