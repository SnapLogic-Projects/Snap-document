 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusMonths(int)}
 *
 * @author tstack
 */
public enum MinusMonths implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusMonths(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
