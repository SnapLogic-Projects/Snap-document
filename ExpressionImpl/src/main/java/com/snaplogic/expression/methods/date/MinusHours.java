 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusHours(int)}
 *
 * @author tstack
 */
public enum MinusHours implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusHours(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
