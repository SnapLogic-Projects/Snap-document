...
import static com.snaplogic.expression.methods.date.Messages.EXPECTING_A_VALUE_IN_RANGE_0_59;
 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#withSecondOfMinute
 * (int)}
 *
 * @author tstack
 */
public enum WithSecondOfMinute implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        try {
            return dateTime.withSecondOfMinute(MethodUtils.getArgAsNumber(args, 0).intValue());
        } catch (IllegalFieldValueException e) {
            throw new SnapDataException(e, INVALID_ARGUMENT)
                    .withReason(e.getMessage())
                    .withResolution(EXPECTING_A_VALUE_IN_RANGE_0_59);
        }
    }
}
