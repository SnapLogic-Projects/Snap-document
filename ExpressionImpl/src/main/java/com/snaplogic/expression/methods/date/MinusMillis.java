 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusMillis(long)}
 *
 * @author tstack
 */
public enum MinusMillis implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusMillis(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
