 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusSeconds(int)}
 *
 * @author tstack
 */
public enum PlusSeconds implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusSeconds(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
