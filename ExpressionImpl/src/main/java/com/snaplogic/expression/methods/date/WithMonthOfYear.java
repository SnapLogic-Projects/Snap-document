...
import static com.snaplogic.expression.methods.date.Messages.EXPECTING_A_VALUE_IN_RANGE_1_12;
 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#withMonthOfYear(int)}
 *
 * @author tstack
 */
public enum WithMonthOfYear implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        try {
            return dateTime.withMonthOfYear(MethodUtils.getArgAsNumber(args, 0).intValue());
        } catch (IllegalFieldValueException e) {
            throw new SnapDataException(e, INVALID_ARGUMENT)
                    .withReason(e.getMessage())
                    .withResolution(EXPECTING_A_VALUE_IN_RANGE_1_12);
        }
    }
}
