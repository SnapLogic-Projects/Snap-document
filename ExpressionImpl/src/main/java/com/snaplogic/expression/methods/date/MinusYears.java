 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#minusYears(int)}
 *
 * @author tstack
 */
public enum MinusYears implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.minusYears(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
