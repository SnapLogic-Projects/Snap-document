 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusHours(int)}
 *
 * @author tstack
 */
public enum PlusHours implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusHours(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
