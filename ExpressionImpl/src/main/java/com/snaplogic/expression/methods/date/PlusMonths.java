 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusMonths(int)}
 *
 * @author tstack
 */
public enum PlusMonths implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusMonths(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
