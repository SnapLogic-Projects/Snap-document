 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plus(long)}
 *
 * @author tstack
 */
public enum Plus implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plus(MethodUtils.getArgAsNumber(args, 0).longValue());
    }
}
