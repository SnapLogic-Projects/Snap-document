 ...
 * {@see http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#plusMillis(int)}
 *
 * @author tstack
 */
public enum PlusMillis implements Method {
    INSTANCE;
    ...
    public Object evaluate(final Object member, final List args) {
        ...
        return dateTime.plusMillis(MethodUtils.getArgAsNumber(args, 0).intValue());
    }
}
